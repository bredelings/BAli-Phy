		 ...
		 vector<ostream*>& files)
{
  ...
  if (has_imodel) {
    ...
    SPR_move.add(2,SingleMove(sample_SPR_all,"SPR_and_A_all","topology:lengths:nodes:alignment:alignment_branch"));
  }
  else {
    ...
    SPR_move.add(2,SingleMove(sample_SPR_all,"SPR_and_A_all","topology:lengths"));
  }
