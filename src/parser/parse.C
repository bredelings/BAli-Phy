...
struct haskell_grammar : qi::grammar<Iterator, expression_ref(), ascii::space_type>
{
	...
	topdecl = 
	  ...
	  //	  | "default" >> *type
	  //	  | "foreign" >> fdecl
	  lit("builtin") >> var[ push_back(_a,construct<String>(_1)) ] >> h_integer[ push_back(_a,construct<String>(_1)) ] >> h_string[ push_back(_a,construct<String>(_1)) ] >> eps[ _val = new_<expression>(AST_node("Builtin"), _a) ]
