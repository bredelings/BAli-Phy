...
std::string enum_class_name = "Compiler.Enum.Enum";
std::string enum_to_enum_name = "Compiler.Enum.toEnum";
std::string enum_from_enum_name = "Compiler.Enum.fromEnum";
std::string enum_from_name = "Compiler.Enum.enumFrom";
std::string enum_from_to_name = "Compiler.Enum.enumFromTo";
std::string enum_from_then_name = "Compiler.Enum.enumFromThen";
std::string enum_from_then_to_name = "Compiler.Enum.enumFromThenTo";
std::string function_compose_name = "Data.Function..";
std::string ix_class_name = "Data.Ix.Ix";
std::string ix_range_name = "Data.Ix.range";
...
std::string control_monad_fix_module_name = "Control.Monad.Fix";
std::string mfix_name = "Control.Monad.Fix.mfix";
