...
#include "computation/optimization/occurrence_info.hh" // for Core::Var<>, Occ::Var
#include "computation/haskell/var.hh" // for Hs::Var
#include "computation/haskell/type.hh" // for Hs::TypeVar
#include "computation/core/type.hh" // for TypeVar

#include "computation/optimization/set-levels.hh" // for Levels::Var
#include "core/ast.hh"
...
public:
    ...
    Core::Var<> get_fresh_core_var(const std::string& name);
    Core::Var<> get_fresh_core_var(const std::string& name, bool qualified);
