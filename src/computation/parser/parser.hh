  ...
  private:
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_tv_bndrs = 223,                        // tv_bndrs
        S_tv_bndr = 224,                         // tv_bndr
        S_kind = 225,                            // kind
        S_constrs = 226,                         // constrs
        S_constrs1 = 227,                        // constrs1
        S_constr = 228,                          // constr
        S_forall = 229,                          // forall
        S_constr_stuff = 230,                    // constr_stuff
        S_fielddecls = 231,                      // fielddecls
        S_fielddecls1 = 232,                     // fielddecls1
        S_fielddecl = 233,                       // fielddecl
        S_maybe_derivings = 234,                 // maybe_derivings
        S_derivings = 235,                       // derivings
        S_deriving = 236,                        // deriving
        S_deriv_clause_types = 237,              // deriv_clause_types
        S_decl_no_th = 238,                      // decl_no_th
        S_decl = 239,                            // decl
        S_rhs = 240,                             // rhs
        S_gdrhs = 241,                           // gdrhs
        S_gdrh = 242,                            // gdrh
        S_sigdecl = 243,                         // sigdecl
        S_activation = 244,                      // activation
        S_explicit_activation = 245,             // explicit_activation
        S_exp = 246,                             // exp
        S_infixexp = 247,                        // infixexp
        S_infixexp_top = 248,                    // infixexp_top
        S_exp10_top = 249,                       // exp10_top
        S_exp10 = 250,                           // exp10
        S_optSemi = 251,                         // optSemi
        S_scc_annot = 252,                       // scc_annot
        S_fexp = 253,                            // fexp
        S_aexp = 254,                            // aexp
        S_aexp1 = 255,                           // aexp1
        S_aexp2 = 256,                           // aexp2
        S_texp = 257,                            // texp
        S_tup_exprs = 258,                       // tup_exprs
        S_list = 259,                            // list
        S_lexps = 260,                           // lexps
        S_squals = 261,                          // squals
        S_transformqual = 262,                   // transformqual
        S_guardquals = 263,                      // guardquals
        S_guardquals1 = 264,                     // guardquals1
        S_altslist = 265,                        // altslist
        S_alts = 266,                            // alts
        S_alts1 = 267,                           // alts1
        S_alt = 268,                             // alt
        S_alt_rhs = 269,                         // alt_rhs
        S_gdpats = 270,                          // gdpats
        S_ifgdpats = 271,                        // ifgdpats
        S_gdpat = 272,                           // gdpat
        S_pat = 273,                             // pat
        S_bindpat = 274,                         // bindpat
        S_apat = 275,                            // apat
        S_apats1 = 276,                          // apats1
        S_stmtlist = 277,                        // stmtlist
        S_stmts = 278,                           // stmts
        S_stmt = 279,                            // stmt
        S_qual = 280,                            // qual
        S_fbinds = 281,                          // fbinds
        S_fbinds1 = 282,                         // fbinds1
        S_fbind = 283,                           // fbind
        S_qcon = 284,                            // qcon
        S_gen_qcon = 285,                        // gen_qcon
        S_con = 286,                             // con
        S_con_list = 287,                        // con_list
        S_sysdcon_no_list = 288,                 // sysdcon_no_list
        S_sysdcon = 289,                         // sysdcon
        S_conop = 290,                           // conop
        S_qconop = 291,                          // qconop
        S_gtycon = 292,                          // gtycon
        S_ntgtycon = 293,                        // ntgtycon
        S_oqtycon = 294,                         // oqtycon
        S_oqtycon_no_varcon = 295,               // oqtycon_no_varcon
        S_qtyconop = 296,                        // qtyconop
        S_qtycondoc = 297,                       // qtycondoc
        S_qtycon = 298,                          // qtycon
        S_tycon = 299,                           // tycon
        S_qtyconsym = 300,                       // qtyconsym
        S_tyconsym = 301,                        // tyconsym
        S_op = 302,                              // op
        S_varop = 303,                           // varop
        S_qop = 304,                             // qop
        S_qopm = 305,                            // qopm
        S_hole_op = 306,                         // hole_op
        S_qvarop = 307,                          // qvarop
        S_qvaropm = 308,                         // qvaropm
        S_tyvar = 309,                           // tyvar
        S_tyvarop = 310,                         // tyvarop
        S_tyvarid = 311,                         // tyvarid
        S_var = 312,                             // var
        S_qvar = 313,                            // qvar
        S_qvarid = 314,                          // qvarid
        S_varid = 315,                           // varid
        S_qvarsym = 316,                         // qvarsym
        S_qvarsym_no_minus = 317,                // qvarsym_no_minus
        S_qvarsym1 = 318,                        // qvarsym1
        S_varsym = 319,                          // varsym
        S_varsym_no_minus = 320,                 // varsym_no_minus
        S_special_id = 321,                      // special_id
        S_special_sym = 322,                     // special_sym
        S_qconid = 323,                          // qconid
        S_conid = 324,                           // conid
        S_qconsym = 325,                         // qconsym
        S_consym = 326,                          // consym
        S_literal = 327,                         // literal
        S_close = 328,                           // close
        S_modid = 329,                           // modid
        S_commas = 330                           // commas
      };
...
switch (yykind)
  ...
  private:
    ...
    enum
    {
      yylast_ = 5146,     ///< Last index in yytable_.
      yynnts_ = 191,  ///< Number of nonterminal symbols.
