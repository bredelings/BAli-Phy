...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    union union_type
    {
      ...
      // inst_type
      // constr_stuff
      char dummy16[sizeof (Hs::Type)];

      // tv_bndr
      char dummy17[sizeof (Hs::TypeVar)];

      // alt
      char dummy18[sizeof (Located<Hs::Alt>)];

      // binds
      char dummy19[sizeof (Located<Hs::Binds>)];

      // qcname
      char dummy20[sizeof (Located<std::string>)];
      ...
      // qopm
      // literal
      char dummy24[sizeof (expression_ref)];

      // "PRIMFLOAT"
      char dummy25[sizeof (float)];
      ...
      // export_subspec
      char dummy27[sizeof (std::optional<Hs::ExportSubSpec>)];

      // maybeimpspec
      char dummy28[sizeof (std::optional<Hs::ImpSpec>)];

      // wherebinds
      char dummy29[sizeof (std::optional<Located<Hs::Binds>>)];

      // prec
      char dummy30[sizeof (std::optional<int>)];

      // maybeas
      char dummy31[sizeof (std::optional<std::string>)];

      // maybeexports
      char dummy32[sizeof (std::optional<std::vector<Hs::Export>>)];

      // tycl_hdr
      char dummy33[sizeof (std::pair<Hs::Context,Hs::Type>)];

      // body
      // body2
      // top
      // top1
      char dummy34[sizeof (std::pair<std::vector<Hs::ImpDecl>, std::optional<Hs::Decls>>)];
      ...
      // constrs
      // constrs1
      char dummy36[sizeof (std::vector<Hs::Constructor>)];

      // exportlist
      // exportlist1
      char dummy37[sizeof (std::vector<Hs::Export>)];

      // fielddecls
      // fielddecls1
      char dummy38[sizeof (std::vector<Hs::FieldDecl>)];

      // gdrhs
      // gdpats
      char dummy39[sizeof (std::vector<Hs::GuardedRHS>)];

      // importdecls
      // importdecls_semi
      char dummy40[sizeof (std::vector<Hs::ImpDecl>)];
      ...
      // comma_types0
      // comma_types1
      char dummy41[sizeof (std::vector<Hs::Type>)];

      // tv_bndrs
      // forall
      char dummy42[sizeof (std::vector<Hs::TypeVar>)];

      // sig_vars
      char dummy43[sizeof (std::vector<Hs::Var>)];

      // alts
      // alts1
      char dummy44[sizeof (std::vector<Located<Hs::Alt>>)];

      // qcnames
      // qcnames1
      char dummy45[sizeof (std::vector<Located<std::string>>)];
      ...
      // apats1
      // stmts
      char dummy46[sizeof (std::vector<expression_ref>)];
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_semis1 = 156,                          // semis1
        S_semis = 157,                           // semis
        S_importdecls = 158,                     // importdecls
        S_importdecls_semi = 159,                // importdecls_semi
        S_importdecl = 160,                      // importdecl
        S_optqualified = 161,                    // optqualified
        S_maybeas = 162,                         // maybeas
        S_maybeimpspec = 163,                    // maybeimpspec
        S_impspec = 164,                         // impspec
        S_prec = 165,                            // prec
        S_infix = 166,                           // infix
        S_ops = 167,                             // ops
        S_topdecls = 168,                        // topdecls
        S_topdecls_semi = 169,                   // topdecls_semi
        S_topdecl = 170,                         // topdecl
        S_cl_decl = 171,                         // cl_decl
        S_ty_decl = 172,                         // ty_decl
        S_inst_decl = 173,                       // inst_decl
        S_overlap_pragma = 174,                  // overlap_pragma
        S_deriv_strategy_no_via = 175,           // deriv_strategy_no_via
        S_deriv_strategy_via = 176,              // deriv_strategy_via
        S_data_or_newtype = 177,                 // data_or_newtype
        S_opt_kind_sig = 178,                    // opt_kind_sig
        S_tycl_hdr = 179,                        // tycl_hdr
        S_capi_ctype = 180,                      // capi_ctype
        S_decls = 181,                           // decls
        S_decllist = 182,                        // decllist
        S_binds = 183,                           // binds
        S_wherebinds = 184,                      // wherebinds
        S_strings = 185,                         // strings
        S_stringlist = 186,                      // stringlist
        S_opt_tyconsig = 187,                    // opt_tyconsig
        S_sigtype = 188,                         // sigtype
        S_sigtypedoc = 189,                      // sigtypedoc
        S_sig_vars = 190,                        // sig_vars
        S_sigtypes1 = 191,                       // sigtypes1
        S_strict_mark = 192,                     // strict_mark
        S_strictness = 193,                      // strictness
        S_ctype = 194,                           // ctype
        S_ctypedoc = 195,                        // ctypedoc
        S_context = 196,                         // context
        S_context_no_ops = 197,                  // context_no_ops
        S_type = 198,                            // type
        S_typedoc = 199,                         // typedoc
        S_btype = 200,                           // btype
        S_btype_no_ops = 201,                    // btype_no_ops
        S_tyapps = 202,                          // tyapps
        S_tyapp = 203,                           // tyapp
        S_atype_docs = 204,                      // atype_docs
        S_atype = 205,                           // atype
        S_inst_type = 206,                       // inst_type
        S_deriv_types = 207,                     // deriv_types
        S_comma_types0 = 208,                    // comma_types0
        S_comma_types1 = 209,                    // comma_types1
        S_tv_bndrs = 210,                        // tv_bndrs
        S_tv_bndr = 211,                         // tv_bndr
        S_kind = 212,                            // kind
        S_constrs = 213,                         // constrs
        S_constrs1 = 214,                        // constrs1
        S_constr = 215,                          // constr
        S_forall = 216,                          // forall
        S_constr_stuff = 217,                    // constr_stuff
        S_fielddecls = 218,                      // fielddecls
        S_fielddecls1 = 219,                     // fielddecls1
        S_fielddecl = 220,                       // fielddecl
        S_maybe_derivings = 221,                 // maybe_derivings
        S_derivings = 222,                       // derivings
        S_deriving = 223,                        // deriving
        S_deriv_clause_types = 224,              // deriv_clause_types
        S_decl_no_th = 225,                      // decl_no_th
        S_decl = 226,                            // decl
        S_rhs = 227,                             // rhs
        S_gdrhs = 228,                           // gdrhs
        S_gdrh = 229,                            // gdrh
        S_sigdecl = 230,                         // sigdecl
        S_activation = 231,                      // activation
        S_explicit_activation = 232,             // explicit_activation
        S_exp = 233,                             // exp
        S_infixexp = 234,                        // infixexp
        S_infixexp_top = 235,                    // infixexp_top
        S_exp10_top = 236,                       // exp10_top
        S_exp10 = 237,                           // exp10
        S_optSemi = 238,                         // optSemi
        S_scc_annot = 239,                       // scc_annot
        S_fexp = 240,                            // fexp
        S_aexp = 241,                            // aexp
        S_aexp1 = 242,                           // aexp1
        S_aexp2 = 243,                           // aexp2
        S_texp = 244,                            // texp
        S_tup_exprs = 245,                       // tup_exprs
        S_list = 246,                            // list
        S_lexps = 247,                           // lexps
        S_squals = 248,                          // squals
        S_guardquals = 249,                      // guardquals
        S_guardquals1 = 250,                     // guardquals1
        S_altslist = 251,                        // altslist
        S_alts = 252,                            // alts
        S_alts1 = 253,                           // alts1
        S_alt = 254,                             // alt
        S_alt_rhs = 255,                         // alt_rhs
        S_gdpats = 256,                          // gdpats
        S_gdpat = 257,                           // gdpat
        S_pat = 258,                             // pat
        S_bindpat = 259,                         // bindpat
        S_apat = 260,                            // apat
        S_apats1 = 261,                          // apats1
        S_stmtlist = 262,                        // stmtlist
        S_stmts = 263,                           // stmts
        S_stmt = 264,                            // stmt
        S_qual = 265,                            // qual
        S_fbinds = 266,                          // fbinds
        S_fbinds1 = 267,                         // fbinds1
        S_fbind = 268,                           // fbind
        S_qcon = 269,                            // qcon
        S_gen_qcon = 270,                        // gen_qcon
        S_con = 271,                             // con
        S_con_list = 272,                        // con_list
        S_sysdcon_no_list = 273,                 // sysdcon_no_list
        S_sysdcon = 274,                         // sysdcon
        S_conop = 275,                           // conop
        S_qconop = 276,                          // qconop
        S_gtycon = 277,                          // gtycon
        S_ntgtycon = 278,                        // ntgtycon
        S_oqtycon = 279,                         // oqtycon
        S_oqtycon_no_varcon = 280,               // oqtycon_no_varcon
        S_qtyconop = 281,                        // qtyconop
        S_qtycondoc = 282,                       // qtycondoc
        S_qtycon = 283,                          // qtycon
        S_tycon = 284,                           // tycon
        S_qtyconsym = 285,                       // qtyconsym
        S_tyconsym = 286,                        // tyconsym
        S_op = 287,                              // op
        S_varop = 288,                           // varop
        S_qop = 289,                             // qop
        S_qopm = 290,                            // qopm
