...
{
  return result(modules_path,vector<Module>{});
}

object_ptr<const Object> formula_expression_ref::result(const vector<string>& modules_path, const vector<Module>& Ps) const
{
