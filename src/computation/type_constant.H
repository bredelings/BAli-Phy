...
enum class type_constant {
    ...
    // anything with type >= 100 and type < first_non_gc_type is gc_able (see is_gcable_type)
    gc_type = 100,

    first_non_gc_type=200,
    modifiable_type,
...
inline bool is_gcable_type(type_constant c) {return c >= type_constant::gc_type and c < type_constant::first_non_gc_type;}

// we test "literal-or-constructor" (2025).
...
inline bool is_whnf_type(type_constant c) {return (c >=type_constant::int_type and c < type_constant::first_non_gc_type);}
