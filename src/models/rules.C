...
//  We need a way to construct lists, not from a distribution.
    ...
    {{"M0","EM[Codon[a,b]]","","Nucleotides[a],AminoAcids[b]"}, {"m0_model","submodel","omega"}, {"omega","Double","~Uniform[0,1]"}, {"submodel","EM[a]","HKY"}},
...
// fraction ~ dirichlet' n (1 + n/2), rates ~ dirichlet' n 2
    ...
    {{"M2a","MM[Codon[a,b]]"}, {"m2a_model","nuc_model","freq_model","omega1","p1","posP","posW"},
    ...
    {{"M7","MM[Codon[a,b]]"}, {"m7_model","nuc_model","freq_model","mu","gamma","n_bins"},
     {"n_bins","Int","4"}, {"nuc_model","EM[a]","HKY"}, {"freq_model","FM[Codon[a,b]]","F61"},{"mu","Double","~Uniform[0,1]"},{"gamma","Double","~Beta[1,10]"}},
    {{"M8","MM[Codon[a,b]]"},
     {"m8_model","nuc_model","freq_model","mu","gamma","n","posP","posW"},
    ...
    {{"M8a","MM[Codon[a,b]]"},
     {"m8a_model","nuc_model","freq_model","mu","gamma","n_bins","posP"},
    ...
    {{"branch-site","MMM[Codon[a,b]]"},
     {"branch_site_test_model","nuc_model","freq_model","fs","omegas","posP","posW","posSelection"},
