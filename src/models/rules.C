...
// fraction ~ dirichlet' n (1 + n/2), rates ~ dirichlet' n 2
    ...
    {{"M7", "MM[Codon[a,b]]", "G"},
     {"SModel.m7[nuc_model,freq_model,mu,gamma,n_bins,A]"},
     {"n_bins", "Int", "4"},
     {"nuc_model", "EM[a]", "HKY", "Alphabet.getNucleotides[A]"},
     {"freq_model", "FM[Codon[a,b]]", "F61", "A"},
    ...
    {{"M8a", "MM[Codon[a,b]]","G"},
     {"SModel.m8a[nuc_model,freq_model,mu,gamma,n_bins,posP,A]"},
     {"n_bins", "Int", "4"},
     {"nuc_model", "EM[a]", "HKY", "Alphabet.getNucleotides[A]"},
     {"freq_model", "FM[Codon[a,b]]", "F61", "A"},
     {"mu", "Double", "~Uniform[0,1]"},
    ...
    {{"M8a_Test", "MM[Codon[a,b]]","G"},
     {"SModel.m8a_test[nuc_model,freq_model,mu,gamma,n_bins,posP,posW,posSelection,A]"},
     {"n_bins", "Int", "4"},
     {"nuc_model", "EM[a]", "HKY", "Alphabet.getNucleotides[A]"},
     {"freq_model", "FM[Codon[a,b]]", "F61", "A"},
     {"mu", "Double", "~Uniform[0,1]"},
