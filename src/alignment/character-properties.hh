...
struct summary
{
    ...
    std::vector<std::uint64_t> retained_samples_by_chain;
    std::map<std::string, property_summary> properties;
    std::map<std::string, conditioned_summary> conditioned;
};
