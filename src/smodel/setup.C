...
const vector< vector<vector<string>> > all_default_arguments = 
{
    ...
    {{"logGamma","Double"}, {"logGamma_model","a","b"}, {"a","Double"}, {"b","Double"}},
    {{"Beta","Double"}, {"beta_model","a","b"}, {"a","Double"}, {"b","Double"}},
    {{"Dirichlet","List[Double]"}, {"dirichlet'_model","n","x"}, {"n","Int"}, {"x","Double"}},
//    {{"Dirichlet","List[Double]"}, {"dirichlet_model","ps"}, {"ps","List[Double]"}},
    {{"Geometric","Int"}, {"geometric_model","p"}, {"p","Double"}},
    {{"EQU","EM[a]"}, {}},
