...
sample_uniform l u = RandomStructure do_nothing modifiable $ liftIO (IOAction2 builtin_sample_uniform l u)
...
sample_uniform_int l u = RandomStructure do_nothing modifiable $ liftIO (IOAction2 builtin_sample_uniform_int l u)
