...
data Matrix
data Partition = Partition SModel (Maybe IModel) Double Tree (Array Int LeafSequence) AlignmentOnTree (Maybe (Array Int HMM)) (Array Int Matrix) (Array Int ConditionalLikelihoodVector)
...
get_alignment       (Partition _ _ _ _  _  as _  _  _ ) = as
