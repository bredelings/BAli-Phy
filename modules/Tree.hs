...
rooted_tree t r = RootedTree t r (mkArray n check_away_from_root) where
    {
      check_away_from_root b = sourceNode t b == root t || or $ map (away_from_root t) (edgesBeforeEdge t);
      n = numBranches t * 2;
    };
