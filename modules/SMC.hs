...
smc rho_over_theta rates level_boundaries = ProbDensity (\a->[smc_density rho_over_theta rates level_boundaries a]) (error "SMC has no quantile") (return 0) (listToString("AlignmentRangeString"))
