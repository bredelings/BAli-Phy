...
smc rho_over_theta rates level_boundaries error_rate = Distribution (\a->[smc_density rho_over_theta rates level_boundaries error_rate a]) (error "SMC has no quantile") (return 0) (listToString("AlignmentRangeString"))
