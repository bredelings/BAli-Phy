...
foreign import bpcall "Data:read_file_lines" builtin_read_file_lines 1
foreign import bpcall "Data:string_to_double" cpp_string_to_double 1
foreign import bpcall "Data:string_to_int" cpp_string_to_int 1
