...
builtin "Alignment:leaf_sequence_counts" builtin_leaf_sequence_counts 3
...
builtin "Alignment:compress_alignment" builtin_compress_alignment 1
...
builtin "Alignment:uncompress_alignment" builtin_uncompress_alignment 2
...
builtin "Alignment:ancestral_sequence_alignment" builtin_ancestral_sequence_alignment 3
ancestral_sequence_alignment a0 states smap = builtin_ancestral_sequence_alignment a0 states smap

builtin "Alignment:select_alignment_columns" builtin_select_alignment_columns 2
select_alignment_columns alignment sites = builtin_select_alignment_columns alignment (list_to_vector sites)

builtin "Alignment:select_alignment_pairs" builtin_select_alignment_pairs 3
