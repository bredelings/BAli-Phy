...
foreign import bpcall "Alignment:alignment_length" alignment_length 1

builtin_load_alignment :: Alphabet -> CPPString -> AlignmentMatrix
foreign import bpcall "Alignment:load_alignment" builtin_load_alignment 2
...
foreign import bpcall "Alignment:alignment_from_sequences" builtin_alignment_from_sequences 2
...
foreign import bpcall "Alignment:sequences_from_alignment" builtin_sequences_from_alignment 1
...
foreign import bpcall "Alignment:sequence_names" builtin_sequence_names 1
...
foreign import bpcall "Alignment:reorder_alignment" builtin_reorder_alignment 2
...
foreign import bpcall "Bits:alignment_row_to_presence_bitvector" builtin_alignment_row_to_bitvector 2
