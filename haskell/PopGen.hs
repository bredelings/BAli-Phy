...
afs args = Distribution "afs" (ewens_sampling_probability args) (error "afs has no quantile") () ()

afsGroup args = Distribution "afsGroup" (ewens_sampling_group_probability args) (error "afsGroup has no quantile") () ()

afsMixture thetas ps = Distribution "afsMixture" (ewens_sampling_mixture_probability thetas ps) (error "afsMixture has no quantile") () ()

selfing_coalescence n_loci s = Distribution "selfing_coalescence" (selfing_coalescence_probability n_loci s) (error "selfing_coalescence has no quantile") (replicate n_loci False) (ListRange (replicate n_loci TrueFalseRange))

li_stephens_2003 rho = Distribution "li_stephens_2003" (make_densities $ li_stephens_2003_composite_likelihood rho) (error "li_stephens_2003 has no quantile") () ()
