...
foreign import bpcall "SModel:f2x4_frequencies" f2x4_frequencies_builtin 3
foreign import bpcall "SModel:singlet_to_doublet_rates" singlet_to_doublet_rates 3
...
foreign import bpcall "SModel:rna_16a_exchange" rna_stem_16a_exchange 6

rna_stem_16a a aS aD b g e pi = gtr a (rna_stem_16a_exchange a aS aD b g e) pi

foreign import bpcall "SModel:rna_editting_rates" rna_editting_rates 3
foreign import bpcall "SModel:rna_editting_pi" rna_editting_pi 3
