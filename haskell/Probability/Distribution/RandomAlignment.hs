...
foreign import bpcall "Alignment:transition_counts" transition_counts :: () -> ()
foreign import bpcall "Alignment:pairwise_alignment_probability_from_counts" pairwise_alignment_probability_from_counts :: () -> () -> ()
