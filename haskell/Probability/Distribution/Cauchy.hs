...
builtin "Distribution:cauchy_density" cauchy_density 3
builtin "Distribution:cauchy_quantile" cauchy_quantile 3
builtin "Distribution:sample_cauchy" builtin_sample_cauchy 3
