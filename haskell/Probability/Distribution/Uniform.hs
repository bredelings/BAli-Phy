...
foreign import bpcall "Distribution:uniform_density" uniform_density :: () -> () -> () -> ()
foreign import bpcall "Distribution:sample_uniform" builtin_sample_uniform :: () -> () -> () -> ()
...
foreign import bpcall "Distribution:uniform_int_density" uniform_int_density :: () -> () -> () -> ()
foreign import bpcall "Distribution:sample_uniform_int" builtin_sample_uniform_int :: () -> () -> () -> ()
