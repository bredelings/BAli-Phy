...
foreign import bpcall "Distribution:uniform_density" uniform_density 3
foreign import bpcall "Distribution:sample_uniform" builtin_sample_uniform 3
...
foreign import bpcall "Distribution:uniform_int_density" uniform_int_density 3
foreign import bpcall "Distribution:sample_uniform_int" builtin_sample_uniform_int 3
