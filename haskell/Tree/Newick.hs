...
writeNewickRooted tree = let nodes = writeNewick_node tree (root tree)
                             attributes = attributesText $ getAttributes tree
                         in if T.null attributes
                            then nodes
                            else T.concat [attributes,T.singleton ' ',nodes]

writeNewick tree = case isRooted tree of Unrooted -> writeNewickRooted $ addRootAnywhere tree
                                         Rooted -> writeNewickRooted tree
